...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: Color(0xff3B5FF6), opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: Color(0xff3B5FF6)),
        unselectedLabelTextStyle: TextStyle(color: Color(0xff495057))),
    colorScheme: ColorScheme.light(
        primary: Color(0xff3B5FF6),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Color(0xff3B5FF6)),
      ),
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
        backgroundColor: Color(0xff3B5FF6),
        splashColor: Colors.white.withAlpha(100),
        highlightElevation: 8,
        elevation: 4,
        focusColor: Color(0xff3B5FF6),
        hoverColor: Color(0xff3B5FF6),
        foregroundColor: Colors.white),
    dividerColor: Color(0xffd1d1d1),
    errorColor: Color(0xfff0323c),
    cardColor: Colors.white,
    hintColor: Color(0xff3B5FF6),
    ...
    tabBarTheme: TabBarTheme(
      ...
      labelColor: Color(0xff3B5FF6),
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: Color(0xff3B5FF6), width: 2.0),
      ),
    ),
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff3B5FF6),
      inactiveTrackColor: Color(0xff3B5FF6).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff3B5FF6),
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        primary: Color(0xff3B5FF6),
        primaryVariant: Color(0xff3B5FF6),
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: Color(0xff3B5FF6),
        inactiveTrackColor: Color(0xff3B5FF6).withAlpha(100),
        trackShape: RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
        thumbColor: Color(0xff3B5FF6),
        thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),
  ...
  static NavigationBarTheme getNavigationThemeFromMode(int themeMode) {
    ...
    if (themeMode == themeLight) {
      ...
      navigationBarTheme.selectedItemColor = Color(0xff3B5FF6);
      navigationBarTheme.unselectedItemColor = Color(0xff495057);
      navigationBarTheme.selectedOverlayColor = Color(0x383B5FF6);
    } else if (themeMode == themeDark) {
