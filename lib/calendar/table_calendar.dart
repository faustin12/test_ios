          ...
          setState(() {
            ...
            if (runCallback && widget.onDaySelected != null) {
              final key = widget.events.keys.firstWhere(
                (it) => DateUtils.isSameDay(it, widget.selectedDay)//, orElse: () => null,
              );
  ...
  Widget _buildHeader() {
    final children = [
      CustomIconButton(
        ...
        onTap: (){
          widget.headerStyle.onLeftChevronClick!();
        },
      ...
      CustomIconButton(
        ...
        onTap: (){
          widget.headerStyle.onRightChevronClick!();
        },
    ...
    if (widget.builders.singleMarkerBuilder != null) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          color: date.isBefore(DateTime.now().subtract(Duration(days: 1))) ? widget.calendarStyle.outsideMarkersColor : widget.calendarStyle.markersColor,
        ),
      );
    }
  }
