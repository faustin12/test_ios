...
class HeaderStyle {
  ...
  /// Action to perform when left chevron is cliked
  final OnTap? onLeftChevronClick;

  /// Action to perform when right chevron is cliked
  final OnTap? onRightChevronClick;
  ...
  const HeaderStyle({
    ...
    this.onLeftChevronClick,
    this.onRightChevronClick,
  });
}
