...
class CalendarStyle {
  ...
  /// Color of event markers placed on the bottom of every passed day containing events.
  final Color outsideMarkersColor;

  /// Color of event markers placed on the bottom of today if containing events.
  final Color todayMarkersColor;
  ...
  const CalendarStyle({
    ...
    this.todayMarkersColor = const Color(0xFF263238), // Material blueGrey[900]
    this.outsideMarkersColor = const Color(0xFFF44336), // Material red[500]
